...
namespace Steropes.Tiles.MonogameDemo.GameData.Dungeon.Simple
{
                                           ...
                                           IContainerReferenceProvider<ICharacter>
  {
    ...
    class ContainerReference<T> : IContainerReference, IEquatable<ContainerReference<T>> where T : struct
    {
      readonly T entityId;
      ...
      public bool Equals(ContainerReference<T> other)
      {
        ...
        return Equals(entityId, other.entityId) && ReferenceType == other.ReferenceType;
      }
