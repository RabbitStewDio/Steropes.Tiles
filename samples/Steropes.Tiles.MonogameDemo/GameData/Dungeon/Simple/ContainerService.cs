...
namespace Steropes.Tiles.MonogameDemo.GameData.Dungeon.Simple
{
  public class ContainerService : IContainerService, IItemContainerService
  {
    ...
    static readonly IEnumerable<IItem> emptySingleton = Enumerable.Empty<IItem>();
    ...
    public IEnumerable<IItem> Contents(IContainerReference container)
    {
      if (!containers.TryGetValue(container, out Container c))
      {
    ...
    class Container
    {
      ...
      public LinkedList<IItem> Items { get; }
      ...
      public IEnumerable<IItem> Contents()
      {
