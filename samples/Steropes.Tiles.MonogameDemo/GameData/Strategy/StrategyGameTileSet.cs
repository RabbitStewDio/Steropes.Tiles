...
namespace Steropes.Tiles.MonogameDemo.GameData.Strategy
{
  ...
  public static class StrategyGameTileSetExtensions
  {
    ...
    public static bool FindFirstTile<TRenderTile>(this ITileRegistry<TRenderTile> tileSet, IRuleElement t, out TRenderTile result)
    {
      foreach (var tg in t.AllGraphicTags())
      {
  ...
  public class StrategyGameTileSet : IStrategyGameTileSet
  {
    public StrategyGameTileSet(ITexturePack textures,
    ...
    public ITexturePack Textures { get; }
    ...
    public static void Init(StrategyGameTileSet ts, StrategyGameRules r)
    {
