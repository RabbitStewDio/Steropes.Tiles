...
{
  public class DungeonGameItemLocationResolver<TContext>: IRenderCallbackFilter<ITexturedTile, IItem, ITexturedTile, TContext>
  {
    ...
    public IRenderCallback<ITexturedTile, TContext> RenderTarget { get; set; }
    ...
    public void Draw(ITexturedTile tile, 
                     IItem context, 
                     SpritePosition pos, 
