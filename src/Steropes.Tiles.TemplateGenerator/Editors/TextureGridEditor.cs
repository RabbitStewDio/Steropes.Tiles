    ...
    public partial class TextureGridEditor : UserControl, IDetailEditor<TextureGrid>
    {
        ...
        public TextureGridEditor()
        {
            ...
            validator = new FormValidator()
            {
                ...
                cellSpacingBox.CreateValidator()
                              .ForProvider(errorProvider)
