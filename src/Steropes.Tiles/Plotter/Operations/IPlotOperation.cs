...
{
  public interface IPlotOperation
  {
    void StartDrawing();
    ...
    /// <summary>
    ///  Cache control. It is simply easier to require these methods for all implementations
    ///  and then leave them as NoOps than to try to patch them through in a more minimalistic
    ///  interface.
    /// </summary>
