...
{
  /// <summary>
  ///  A helper data structure that collects items and at the end executes an action over the sorted set of entries.
  ///  Use this if you need to draw sprites/tiles in a particular order that is not guaranteed by the system. The
  /// most common use for this structure sorts item/character tiles based on the y/z axis within a set of tiles.
  /// </summary>
